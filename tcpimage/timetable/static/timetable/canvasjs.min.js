...
v&&(n.setAttribute("state",v),n.setAttribute("type","button"),U(n,{padding:"25px 42px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),n.setAttribute("title",h._cultureInfo[v+"Text"]),n.innerHTML="<img src='"+kb[v].image+"' alt='"+h._cultureInfo[v+"Text"]+"' />",U(n.childNodes[0],{height:"95%",pointerEvents:"none"}))}function La(){for(var h=null,n=0;n<arguments.length;n++)h=arguments[n],h.style&&(h.style.display="inline")}function ua(){for(var h=
